...
namespace PerfectForwarding {
    ...
    static void Referenzen()
    {
        int n = 123;

        int& rn = n;
        // Alias für benannte Objekte / Variablen
        ...
        zeichenketten.push_back(std::move(s1));  // Kopie

        zeichenketten.push_back(s1 + s2);  // Verschieben
    }
