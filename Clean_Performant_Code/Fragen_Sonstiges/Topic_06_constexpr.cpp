...
void test_constexpr()
{
    ...
    auto malZwei = [](int n) { return n * 2; };

    constexpr auto x = [](int n) { return n * 2; };

    constexpr auto result 
        = [](int n) { return n * 2; } (5);

    constexpr auto result2 = x(10);

    constexpr auto result3 = x(20);

    // Option:
    // komplexe Berechnungen im Makro-Stil
