...
namespace LowLevel_MemoryFunctions_Functions {
    ...
    namespace Class_Integer {
        ...
        public:
            ...
            // Konvertierungskonstruktor: int ==> Integer
    ...
    static constexpr size_t Iterations = 1'00;
    ...
    namespace Benchmark_Example_Using_Class_Integer {
        ...
        void static test_class_integer_standard_copy() {
            ...
            std::println("test_class_integer_standard_copy");
        ...
        void static test_class_integer_uninitialized_copy() {
            ...
            std::println("test_class_integer_uninitialized_copy");
    ...
    namespace Benchmark_Example_Using_Class_StdString {
        ...
        void static test_class_std_string_standard_copy() {
            ...
            std::array<std::string, Size> strings{ "ThisAAAAAAAAAAAAAAAAAAAAAA", "isAAAAAAAAAAAAAAAAAAAAAA", "anAAAAAAAAAAAAAAAAAAAAAA", "arrayAAAAAAAAAAAAAAAAAAAAAA", "ofAAAAAAAAAAAAAAAAAAAAAA", "stringsAAAAAAAAAAAAAAAAAAAAAA" };

            std::println("test_class_std_string_standard_copy");
        ...
        void static test_class_std_string_uninitialized_copy() {
            ...
            std::println("test_class_std_string_uninitialized_copy");
