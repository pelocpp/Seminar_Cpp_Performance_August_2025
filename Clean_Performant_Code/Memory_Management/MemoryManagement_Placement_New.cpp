...
namespace Placement_New_Example {
    ...
    namespace BigData_Classic_Implementation
    {
        ...
        public:
                ...
                : m_elems{ new T[size] }, m_size{ size }
            {
                ...
                // In Bezug auf m_elems[0], m_elems[1], ..
                // m_elems[i] = init;
            }
    ...
    static void test_placement_new_example_seminar()
    {

        using namespace BigData_Classic_Implementation;

        //Person hans{ "Hans", "Mueller", 30 };
        //Person sepp{ "Sepp", "Mueller", 30 };
        //sepp = hans;

        Person dummy{"Hans", "Mueller", 30};

        BigData<Person> persons(5, dummy);
    }
...
void memory_management_placement_new()
{
 ...
 //   Placement_New_Example::test_placement_new_example_seminar();
